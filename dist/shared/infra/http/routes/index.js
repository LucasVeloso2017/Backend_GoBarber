...
var apointments_routes_1 = __importDefault(require("@modules/appointments/infra/http/routes/apointments.routes"));
...
routes.use('/appointments', apointments_routes_1.default);
