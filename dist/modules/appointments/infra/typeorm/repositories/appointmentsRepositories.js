...
var AppointmentstRepository = /** @class */ (function () {
    function AppointmentstRepository() {
        this.ormRepository = typeorm_1.getRepository(appointment_1.default);
    }
    AppointmentstRepository.prototype.findByDate = function (date) {
    ...
    AppointmentstRepository.prototype.create = function (_a) {
    ...
    AppointmentstRepository.prototype.findAllInMonthFromProvider = function (_a) {
        var provider_id = _a.provider_id, month = _a.month, year = _a.year;
        return __awaiter(this, void 0, void 0, function () {
            var parsedMonth, appointment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    AppointmentstRepository.prototype.findAllInDayFromProvider = function (_a) {
    ...
    return AppointmentstRepository;
}());
exports.default = AppointmentstRepository;
