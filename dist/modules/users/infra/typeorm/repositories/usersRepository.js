    ...
    UsersRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        user = this.ormRepository.create({ name: name, email: email, password: password, admin: admin, costumer: costumer });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.ormRepository.delete({ id: user.id })];
                    case 2:
                        _a.sent();
                        _a.label = 3;
