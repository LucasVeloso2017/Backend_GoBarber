...
var EtherealMailProvider = /** @class */ (function () {
    function EtherealMailProvider(mailTemplateProvider) {
        ...
        nodemailer_1.default.createTestAccount().then(function (acount) {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _d = {
                            from: {
                                name: (from === null || from === void 0 ? void 0 : from.name) || 'Equipe Gobarber equipegobarber@gobarber.com.br',
                                address: (from === null || from === void 0 ? void 0 : from.name) || 'equipegobarber@gobarber.com.br'
                            },
                            to: {
                                name: to.name,
                                address: to.email
