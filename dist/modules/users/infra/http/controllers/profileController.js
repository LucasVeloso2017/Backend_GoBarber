...
var ProfileController = /** @class */ (function () {
    ...
    ProfileController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, password, old_password, user_id, updateProfileService, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, name = _a.name, email = _a.email, password = _a.password, old_password = _a.old_password;
                        user_id = request.user.id;
                        updateProfileService = tsyringe_1.container.resolve(UpdateProfileService_1.default);
                        return [4 /*yield*/, updateProfileService.execute({
                                name: name, email: email, password: password, old_password: old_password, user_id: user_id
                            })
