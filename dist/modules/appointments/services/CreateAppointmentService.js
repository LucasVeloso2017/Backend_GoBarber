...
var CreateAppointmentService = /** @class */ (function () {
    function CreateAppointmentService(appointmentsRepository, notificationsRepositories) {
        this.appointmentsRepository = appointmentsRepository;
        this.notificationsRepositories = notificationsRepositories;
    }
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (provider_id === user_id) {
                            throw new appError_1.default('You cant create an appointment with yourself');
                        }
                        if (date_fns_1.isBefore(appointmentDate, new Date(Date.now()))) {
                            throw new appError_1.default('You cant create appointment in past date');
                        }
                        return [4 /*yield*/, this.appointmentsRepository.findByDate(appointmentDate)];
                    case 1:
                        findAppointmentInSameDate = _b.sent();
                        if (findAppointmentInSameDate) {
                            throw new appError_1.default('this appointment this already booked');
                        }
                        if (date_fns_1.getHours(appointmentDate) < 8 || date_fns_1.getHours(appointmentDate) > 17) {
                            throw new appError_1.default('You cant only create appointments between 8:00 to 17:00 ');
                        }
                    ...
                    case 2:
                        appointment = _b.sent();
                        dateFormated = date_fns_1.format(appointmentDate, "dd/MM/yyyy 'às' HH:mm'h'");
                        return [4 /*yield*/, this.notificationsRepositories.create({
    ...
    CreateAppointmentService = __decorate([
        ...
        __param(1, tsyringe_1.inject('NotificationsRepositories')),
