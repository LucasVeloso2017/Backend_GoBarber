...
var AppointmentsController = /** @class */ (function () {
    ...
    AppointmentsController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var user_id, _a, provider_id, date, parsedDate, createAppointmentService, appointment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        createAppointmentService = tsyringe_1.container.resolve(CreateAppointmentService_1.default);
