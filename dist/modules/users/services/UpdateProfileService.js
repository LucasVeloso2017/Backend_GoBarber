...
var UpdateProfileService = /** @class */ (function () {
    ...
    UpdateProfileService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, userWithUpdatedEmail, checkOldPass, _b;
                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (userWithUpdatedEmail && userWithUpdatedEmail.id !== user_id) {
                            throw new appError_1.default("This email already used");
                        }
                        user.name = name;
                        user.email = email;
                    ...
                    case 3:
                        checkOldPass = _c.sent();
                        if (!checkOldPass) {
                            throw new appError_1.default("Old doesnt match");
                        }
                        _b = user;
