...
var AuthUserService = /** @class */ (function () {
    function AuthUserService(usersRepository, hashProvider) {
    ...
    AuthUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, passwordMacthed, _b, secret, expiresIn, token;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        passwordMacthed = _c.sent();
                        if (!passwordMacthed) {
                            throw new appError_1.default('Incorrect Email/Password', 401);
                        }
                        _b = config_1.default.jwt, secret = _b.secret, expiresIn = _b.expiresIn;
